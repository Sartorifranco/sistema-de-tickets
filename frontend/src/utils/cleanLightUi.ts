...
export const clInput =
    'w-full px-3 py-2.5 text-sm font-semibold bg-white border border-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-red-100 focus:border-red-400';
export const clTh =
