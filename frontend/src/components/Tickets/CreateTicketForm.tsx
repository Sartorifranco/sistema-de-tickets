            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="title" 
                        name="title" 
                        className="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-900 bg-white leading-tight focus:outline-none focus:ring-2 focus:ring-red-500"
                ...
                <div>
                    ...
                    <textarea 
                        id="description" 
                        name="description" 
                        className="shadow appearance-none border rounded-md w-full py-2 px-3 text-gray-900 bg-white leading-tight focus:outline-none focus:ring-2 focus:ring-red-500 h-32 resize-y"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select 
                            id="priority" 
                            name="priority" 
                            className="block appearance-none w-full bg-white border border-gray-300 text-gray-900 py-2 px-3 pr-8 rounded-md leading-tight focus:outline-none focus:ring-2 focus:ring-red-500"
                        ...
                        >
                            ...
                            <option value="urgent" className="text-gray-900 font-bold">Urgente</option>
                        </select>
                    </div>
                    {/* Departamento */}
                    <div>
                        ...
                        >
                            {loadingInitialData ? <option className="text-gray-500">Cargando...</option> : (
                                <>
                                    <option value="" className="text-gray-500">Selecciona un departamento</option>
                                    {departments.map(dep => (
